    ...
    $.fn.easySelect = function (options) {
        return this.each(function () {
           ...
           var clear = $('<span/>',{
            ...
            // The loop that creates our options
...
/*--================================*/
            ...
            // Check for existing selected elements
            $('.mulpitply_checkbox_style').each(function () {
                var easySelectInputValue = $(this).val();
                var inArray = $.inArray( easySelectInputValue, $this.val() );
                if ( inArray !== -1 || easySelectInputValue == $this.val() ) {
                    console.log('Looks like this value is selected: ' + easySelectInputValue);
